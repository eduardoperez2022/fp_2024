...
public class Ejercicio903 {
    ...
    public static void main(String[] args) {
        ...
        String elgrupo="";
        // grupo A
        if (sexo1.equalsIgnoreCase("F")) {
            if (letra_nombre.compareToIgnoreCase("M") < 0) {
                elgrupo = "A";
            }
            else {
                elgrupo = "B";
        ...
        else if (sexo1.equalsIgnoreCase("M")) {
            if (letra_nombre.compareToIgnoreCase("N") > 0) {
                elgrupo = "A";
            }
            else {
                elgrupo = "B";
